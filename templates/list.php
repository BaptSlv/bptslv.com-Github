  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Mes To Do Lists</li>
      </ol>
      <!-- Ajouter catégories -->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-list"></i> Créer une catégorie</div>
        <div class="card-body">
          <!-- Formulaire catégories -->
          <form action="" method="post">
            <div class="row justify-content-md-center">
              <div class="col-md-auto">
                <p>Catégorie de tache :</p> <input class="form-control" type="text" name="name"/>
              </div>
            </div>
            <div class="row justify-content-md-center">
        ...
        <div class="card-footer small text-muted">Date de dernière modification
        </div>
      </div>
      <!-- Ajouter taches -->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-list"></i> Ajoutez une tache</div>
        <div class="card-body">
          <!-- Formulaire taches -->
          <form action="" method="post">
            <div class="row justify-content-md-center">
              <div class="col-md-auto">
                <p>Catégorie de tache :</p> 
                <select name="categoryId" class="custom-select">
                  <?= $listD ?>
                </select>
              </div>
              <div class="col-md-auto">
                <p>Tache :</p> <input class="form-control" type="text" name="desctache"/>
              </div>
              <div class="col-md-auto">
                <p>Niveau d'importance :</p>
                  <p><select name="lvltache" class="custom-select">
                    <option value="1">1 (Bas)</option>
                    <option value="2">2 (Modéré)</option>
                    <option value="3">3 (Elevé)</option>
                  </select></p>
              </div>
            </div>
            <div class="row justify-content-md-center">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-list"></i> Vos taches urgentes</div>
        <div class="card-body">
